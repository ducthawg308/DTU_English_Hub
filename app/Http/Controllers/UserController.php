...
class UserController extends Controller
{
    ...
    //         // Fetch weak topics based on the weakest skill
    ...
    //                             $weakTopics[] = [
    //                                 'title' => $audio->title,
    //                                 'topic' => $audio->title ?? 'Chưa xác định',
    //                                 'score' => $submission->listening_score,
    //                             ];
    //                         }
    ...
    //                             $weakTopics[] = [
    //                                 'title' => $passage->title,
    //                                 'topic' => $passage->title ?? 'Chưa xác định',
    //                                 'score' => $submission->reading_score,
    //                             ];
    //                         }
    //                 }
    //             }
