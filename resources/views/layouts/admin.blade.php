...
<html lang="en">
    <head>
        ...
        <title>DailyDictation - Admin</title>
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="{{ route('home') }}">DailyDictation Admin</a>
            <!-- Sidebar Toggle-->
            ...
            <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                <div class="input-group">
                    ...
                    <p class="text-center fw-semibold text-secondary mb-0"> {{ Auth::user()->name }}</p>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <a class="nav-link" href="{{url('admin/exam/list')}}">
                                <div class="sb-nav-link-icon"><i class="fa-solid fa-note-sticky"></i></i></div>
