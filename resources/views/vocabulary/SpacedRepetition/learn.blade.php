...
@section('content')
    <div class="container border rounded-3 shadow my-5 p-5">
        <div class="d-flex justify-content-center align-items-center mb-4">
            <h1 class="h3 fw-bold text-primary display-6">Box {{ $box_type }}: {{ $box_type == 1 ? 'Dễ Nhớ' : ($box_type == 2 ? 'Dễ Quên' : 'Rất Dễ Quên') }}</h1>
        </div>
        <div class="card-body">
    ...
    <script>
        ...
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (!vocabularys || vocabularys.length === 0) {
                ...
                wordElement.textContent = "No vocabulary available";
                pronounceElement.textContent = "";
