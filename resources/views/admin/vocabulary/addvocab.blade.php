...
@section('content')
    <div class="container">
        <div class="card shadow-lg border-1 rounded-lg mt-1">
            ...
            <div class="card-body">
                <form method="POST" action="{{ url('admin/vocabulary/addtopic/storevocab') }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-floating mb-3">
                        <input class="form-control" id="inputMeaning" name="meaning" type="text" placeholder="Meaning" />
                    ...
                    <div class="mb-3">
                        <label for="inputImage" class="form-label">Hình ảnh minh họa</label>
                    ...
                    <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                        <button class="btn btn-primary" type="submit">Thêm từ vựng</button>
                    </div>
                </form>
            </div>
        </div>
